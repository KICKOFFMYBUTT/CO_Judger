...
int main(int argc, char *argv[])
{
    // 2 arguments
    if (argc < 3) {
        printf("Arguments too few. standard display and CPU display needed.\n");
        printf("Usage: displaychecker [standard_display_message] [cpu_display_message] \n");
        return -1;
    }
